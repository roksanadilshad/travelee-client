...
import {  Star, ChevronDown, Check, Calendar, Users, Clock, Share2, Heart } from "lucide-react";
            ...
            >
              ...
              <div className="space-y-3">
                <details className="bg-white p-4 rounded-lg border border-gray-200 group">
                  ...
                  <p className="mt-3 text-gray-600 text-sm">
                    Yes! We offer customizable itineraries. Contact our team to discuss your preferences and well create 

    ...
    >
      <FieldGroup>
        ...
        <Field className="pt-2">
          <Button type="submit" className="cursor-pointer" disabled={loading || isUploading}>
        ...
        <div className="">
          <Button variant="outline" onClick={handleGoogleSignUp} type="button"
            className="cursor-pointer hover:bg-muted-foreground flex items-center gap-2 w-full">

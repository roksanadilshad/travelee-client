        ...
        <header className="flex h-16 shrink-0 justify-between pr-5 items-center gap-2 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12">
          <div className="flex items-center gap-2 px-4">
            ...
            <Separator
              ...
              className="mr-2 bg-accent data-[orientation=vertical]:h-4"
            />
            <Breadcrumb>
              <BreadcrumbList>
          ...
          <div className="flex items-center gap-4">
            <Field className="hidden md:block" orientation="horizontal">
              <Input type="search" placeholder="Search..." />
            </Field>
            <Bell size={20} />
          </div>
        </header>
        <div className="flex bg-gray-200/60 flex-1 flex-col gap-4 p-4 pt-0">{children}</div>
      </SidebarInset>
    </SidebarProvider>
  );
}

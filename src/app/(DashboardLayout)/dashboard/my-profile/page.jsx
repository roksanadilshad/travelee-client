          ...
          <div className="relative group">
            <div className="w-32 h-32 lg:w-40 lg:h-40 rounded-[2.5rem] border-[6px] border-[#F4F7FE] bg-white shadow-2xl overflow-hidden">
              <img
                src={
                  user?.image ||
                  `https://ui-avatars.com/api/?name=${user?.name}&background=0A1D1A&color=fff`
                }
                alt="profile"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="bg-white p-10 rounded-[2.5rem] shadow-sm border border-slate-50">
            <h3 className="font-black text-slate-900 mb-8 uppercase text-xs tracking-[0.2em]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-12">
              ...
              <InfoBlock
                icon={<Phone />}
                label="Phone Number"
                value={user?.phone || "+880 1XXX-XXXXXX"}
              />
              <InfoBlock
                icon={<MapPin />}
                label="Location"
          ...
          <div className="bg-white p-10 rounded-[2.5rem] shadow-sm border border-slate-50 relative overflow-hidden">
            <div className="relative z-10">
              <h3 className="font-black text-slate-900 mb-4 uppercase text-xs tracking-[0.2em]">
                Bio
              </h3>
              <p className="text-slate-500 font-medium leading-loose">
                Passionate traveler and photographer exploring the hidden gems
                of the world. Focused on sustainable travel and documenting
                cultural heritage. Always looking for the next mountain to climb
                or ocean to explore.
              </p>
            </div>

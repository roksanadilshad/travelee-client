...
// FIX 1: Correct Imports for DND-Kit
import { 
  DndContext, 
  KeyboardSensor, 
  PointerSensor, 
...
export default function ProfessionalItinerary() {
  ...
  // FIX 2: Define Sensors inside the main component
  const sensors = useSensors(
    useSensor(PointerSensor, { activationConstraint: { distance: 8 } }),
    useSensor(KeyboardSensor, { coordinateGetter: sortableKeyboardCoordinates })
  );

  // FIX 3: Handle Drag End Logic
  const handleDragEnd = (event) => {
    ...
    // Dispatch a reorder action (Ensure this exists in your itinerarySlice)
    dispatch({
